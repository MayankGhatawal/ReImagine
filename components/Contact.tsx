    ...
    <div className="relative h-full bg-blue-100 transition-colors duration-500 pb-10" id="contact">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center px-5 py-12 gap-10 md:gap-16">
        ...
        <div className="w-full md:w-1/2 space-y-6 px-16 pt-5">
          ...
          {/* Mailto Button */}
          <a
            href="mailto:mayank1ghatawal@gmail.com?subject=Inquiry&body=Hello, I would like to know more about your services."
          >
          ...
          <div className="flex justify-center gap-5 items-center">
            <div className="relative flex flex-col items-center text-xl cursor-pointer group justify-center overflow-hidden text-blue-400" onClick={() => openLink("https://www.linkedin.com/in/mayank-ghatawal/")}>
            ...
            <div className="relative flex flex-col items-center text-xl cursor-pointer group justify-center overflow-hidden text-blue-400"  onClick={() => openLink("https://www.instagram.com/mayank._17205/")}>
                      {/* Upper Layer (Default Text and Icon) */}
                      <div className="group-hover:translate-y-[-100%] transition-transform duration-300 ease flex items-center space-x-2">
                        <span className="font-robert ">Instagram</span>
                         <span><GoArrowUpRight /></span>
                      </div>
                      {/* Lower Layer (Text and Icon on Hover) */}
                      <div className="absolute top-full group-hover:translate-y-[-100%] transition-transform duration-300 ease flex items-center space-x-2" >
            ...
            <div className="relative flex flex-col items-center text-xl cursor-pointer group justify-center overflow-hidden text-blue-400"  onClick={() => openLink("https://github.com/MayankGhatawal")}>
                      {/* Upper Layer (Default Text and Icon) */}
                      <div className="group-hover:translate-y-[-100%] transition-transform duration-300 ease flex items-center space-x-2">
